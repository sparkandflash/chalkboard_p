...
const Home = () => {
    ...
    // In a real implementation, you might still load registries in context or layout,
    // but the DashboardLayout now loads UserRegistries on its own. We just wait a bit or use context.
    // For now we'll just set isLoading to false after mounting since DashboardLayout handles it.
    useEffect(() => {
        const fetchInitialState = async () => {
            // Simulated delay for overall layout if we needed it, but removed for now.
            setIsLoading(false);
        };
        fetchInitialState();
    }, []);
